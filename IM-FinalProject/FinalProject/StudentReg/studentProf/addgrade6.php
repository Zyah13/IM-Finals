...
<body>
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="section" name="section" required>
                        ...
                        <option value="Basalo">Basalo</option>
                        <option value="Cordova">Cordova</option>
                        <option value="Polloso">Polloso</option>
                        <option value="Reambonanza">Reambonanza</option>
                        <option value="Restauro">Restauro</option>
                        <option value="Vicedor">Vicedor</option>
                        <option value="Ylanan">Ylanan</option>
                    </select>
                </div>
    ...
    <script>
        function redirectToStudentList() {
            window.location.href = 'grade6.php';
        }
