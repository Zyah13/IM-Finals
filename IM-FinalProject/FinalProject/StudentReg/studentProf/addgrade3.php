...
<body>
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="section" name="section" required>
                        ...
                        <option value="Cuizon">Cuizon</option>
                        <option value="Lorillo">Lorillo</option>
                        <option value="Norteza">Norteza</option>
                        <option value="Perocho">Perocho</option>
                        <option value="Seguisabal">Seguisabal</option>
                        <option value="Tabanyag">Tabanyag</option>
                    </select>
                </div>
    ...
    <script>
        function redirectToStudentList() {
            window.location.href = 'grade3.php';
        }
