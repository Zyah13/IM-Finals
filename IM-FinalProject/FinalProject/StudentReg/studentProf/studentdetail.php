            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <img src="uploads/<?php echo htmlspecialchars($student['nso_picture']); ?>" alt="NSO Picture" class="img-fluid mb-3">
                    </div>
                    <div class="col-md-8">
                        ...
                        <a href="studentlist.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to Student List</a>
                    </div>
                </div>
            </div>
        </div>
