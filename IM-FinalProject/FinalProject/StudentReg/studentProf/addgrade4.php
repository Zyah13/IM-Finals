...
<body>
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="section" name="section" required>
                        ...
                        <option value="Alfornon">Alfornon</option>
                        <option value="Galiste">Galiste</option>
                        <option value="Octat">Octat</option>
                        <option value="Popera">Popera</option>
    ...
    <script>
        function redirectToStudentList() {
            window.location.href = 'grade4.php';
        }
