   ...
   <div class="search-bar">
    <form method="GET" action="">
        ...
        <select name="section">
            ...
            <?php
            $sections =['Alcala', 'Alfornon', 'Galiste', 'Octat','Popera','Santillan'];
       ...
       <div class="table-container">
           <table class="table table-striped">
               ...
               <tbody>
                   ...
                   $query = "SELECT * FROM students WHERE grade = '4th Grade' $search_query $section_query";
                   ...
                   while ($row = mysqli_fetch_assoc($result)) {
                       ...
                       <tr>
                           ...
                           <td>
                               <a href="grade4student.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">
  ...
  <div class="admin-panel" style="height:487vh;" id="admin-panel">
   ...
   <script>
       ...
       function redirectToAddStudent() {
           window.location.href = 'addgrade4.php';
        }
